...
import { INFO_SESSION_DSI_URL, CAMPUS_TOUR_DSI_URL, TECH_INTERVIEW_DSI_URL, PREP_DSI_URL} from '../constants';
...
export default () => (
  <div className="resources-block">
    ...
    <div className="block">
      <h4>Learn More</h4>
      <ul>
        <li><a target="_blank" rel="noopener noreferrer" href={CAMPUS_TOUR_DSI_URL}>Tour a Campus</a></li>
